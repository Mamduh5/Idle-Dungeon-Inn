...
test("full current gameplay loop and required screenshots", async ({ page }) => {
  ...
  await page.screenshot({ path: shot("01-inn-before-send.png") });

  await clickCanvas(page, 294, 696);
  await page.waitForTimeout(350);
  await page.screenshot({ path: shot("02-tower-traveling.png") });

  await page.waitForTimeout(9500);
  await page.screenshot({ path: shot("03-tower-fighting.png") });

  await page.waitForTimeout(4500);
  await page.screenshot({ path: shot("04-tower-continue-run.png") });

  await clickCanvas(page, 195, 714);
  await page.waitForTimeout(4200);
  await page.screenshot({ path: shot("05-tower-complete-floor.png") });

  await clickCanvas(page, 195, 714);
  await page.waitForTimeout(500);
  await page.screenshot({ path: shot("06-inn-after-return.png") });
  ...
  await page.waitForTimeout(250);
  await page.screenshot({ path: shot("07-heroes-view.png") });

  await clickCanvas(page, 341, 814);
  await page.waitForTimeout(250);
  await page.screenshot({ path: shot("08-build-view.png") });
});
